...
#define PS3_TAG "PS3_GAP"

#define PS3_GAP_ID_HIDC 0x40
#define PS3_GAP_ID_HIDI 0x41
...
/********************************************************************************/
// static tL2CAP_ERTM_INFO ps3_ertm_info = {0};
// static tL2CAP_CFG_INFO ps3_cfg_info = {0};
...
/*******************************************************************************
**
** Function         ps3_gap_init_services
**
...
static uint16_t ps3_gap_init_service(char *name, uint16_t psm, uint8_t security_id)
{
    ...
    {
        ESP_LOGE(PS3_TAG, "%s Registering GAP service %s failed", __func__, name);
    }
    else
    {
        ESP_LOGI(PS3_TAG, "[%s] GAP Service %s Initialized: %d", __func__, name, handle);
    }
...
/*******************************************************************************
**
** Function         ps3_gap_update_connected
**
...
static void ps3_gap_update_connected()
{
    // is_connected = GAP_ConnGetL2CAPCid(gap_handle_hidc) != 0 && GAP_ConnGetL2CAPCid(gap_handle_hidi) != 0;
    is_connected = true;
}
